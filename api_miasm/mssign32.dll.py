...
def mssign32_SignerFreeSignerContext(jitter):
    """
    HRESULT SignerFreeSignerContext(
...
def mssign32_PvkPrivateKeyAcquireContextFromMemory(jitter):
    """
    BOOL PvkPrivateKeyAcquireContextFromMemory(
