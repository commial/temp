...
def credui_CredUICmdLinePromptForCredentials(jitter, get_str, set_str):
    """
    [ERROR_CODE] CredUICmdLinePromptForCredentials(
...
def credui_CredUIConfirmCredentials(jitter, get_str, set_str):
    """
    [ERROR_CODE] CredUIConfirmCredentials(
        PCTSTR pszTargetName,
        BOOL bConfirm
    )
    """
...
def credui_CredUIParseUserName(jitter, get_str, set_str):
    """
    [ERROR_CODE] CredUIParseUserName(
        PCTSTR pszUserName,
        PTSTR pszUser,
...
def credui_CredUIPromptForCredentials(jitter, get_str, set_str):
    """
    [ERROR_CODE] CredUIPromptForCredentials(
...
def credui_CredUIPromptForWindowsCredentials(jitter, get_str, set_str):
    """
    [ERROR_CODE] CredUIPromptForWindowsCredentials(
        PCREDUI_INFO pUiInfo,
        DWORD dwAuthError,
...
def credui_CredUIStoreSSOCredW(jitter):
    """
    [ERROR_CODE] CredUIStoreSSOCredW(
        PCWSTR pszRealm,
        PCWSTR pszUsername,
        PCWSTR pszPassword,
        BOOL bPersist
...
def credui_CredUnPackAuthenticationBuffer(jitter, get_str, set_str):
    """
    BOOL CredUnPackAuthenticationBuffer(
        DWORD dwFlags,
        PVOID pAuthBuffer,
        DWORD cbAuthBuffer,
        LPTSTR pszUserName,
...
def credui_SspiGetCredUIContext(jitter):
    """
    SECURITY_STATUS SspiGetCredUIContext(
...
def credui_SspiPromptForCredentials(jitter, get_str, set_str):
    """
    SECURITY_STATUS SspiPromptForCredentials(
        PCTSTR pszTargetName,
...
def credui_SspiUnmarshalCredUIContext(jitter):
    """
    SECURITY_STATUS SspiUnmarshalCredUIContext(
...
def credui_SspiUpdateCredentials(jitter):
    """
    SECURITY_STATUS SspiUpdateCredentials(
        HANDLE ContextHandle,
        GUID* CredType,
