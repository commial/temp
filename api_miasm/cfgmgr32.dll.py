...
def cfgmgr32_CM_Add_ID_Ex(jitter):
    """"
...
def cfgmgr32_CM_Connect_Machine(jitter):
    """"
...
def cfgmgr32_CM_Delete_Device_Interface_Key(jitter):
    """"
...
def cfgmgr32_CM_Enumerate_Enumerators(jitter):
    """"
...
def cfgmgr32_CM_Enumerate_Enumerators_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Class_Registry_Property(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_ID(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_ID_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_ID_List(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_ID_List_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_ID_List_Size(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_ID_List_Size_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_Interface_List(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_Interface_List_Size(jitter):
    """"
...
def cfgmgr32_CM_Get_DevNode_Registry_Property(jitter):
    """"
...
def cfgmgr32_CM_Get_HW_Prof_Flags(jitter):
    """"
...
def cfgmgr32_CM_Get_HW_Prof_Flags_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Resource_Conflict_Details(jitter):
    """"
...
def cfgmgr32_CM_Locate_DevNode(jitter):
    """"
...
def cfgmgr32_CM_Locate_DevNode_Ex(jitter):
    """"
...
def cfgmgr32_CM_Open_Class_Key(jitter):
    """"
...
def cfgmgr32_CM_Open_Device_Interface_Key(jitter):
    """"
...
def cfgmgr32_CM_Query_And_Remove_SubTree(jitter):
    """"
...
def cfgmgr32_CM_Query_And_Remove_SubTree_Ex(jitter):
    """"
...
def cfgmgr32_CM_Request_Device_Eject(jitter):
    """"
...
def cfgmgr32_CM_Request_Device_Eject_Ex(jitter):
    """"
...
def cfgmgr32_CM_Set_Class_Registry_Property(jitter):
    """"
...
def cfgmgr32_CM_Set_DevNode_Registry_Property(jitter):
    """"
...
def cfgmgr32_CM_Create_DevNode(jitter):
    """"
...
def cfgmgr32_CM_Create_DevNode_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Class_Key_Name(jitter):
    """"
...
def cfgmgr32_CM_Get_Class_Key_Name_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Class_Name(jitter):
    """"
...
def cfgmgr32_CM_Get_Class_Name_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_Interface_Alias(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_Interface_Alias_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_Interface_List_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Device_Interface_List_Size_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_DevNode_Custom_Property(jitter):
    """"
...
def cfgmgr32_CM_Get_DevNode_Registry_Property_Ex(jitter):
    """"
...
def cfgmgr32_CM_Get_Hardware_Profile_Info(jitter):
    """"
...
def cfgmgr32_CM_Get_Hardware_Profile_Info_Ex(jitter):
    """"
...
def cfgmgr32_CM_Open_Class_Key_Ex(jitter):
    """"
...
def cfgmgr32_CM_Register_Device_Interface(jitter):
    """"
...
def cfgmgr32_CM_Register_Device_Interface_Ex(jitter):
    """"
...
def cfgmgr32_CM_Set_DevNode_Registry_Property_Ex(jitter):
    """"
...
def cfgmgr32_CM_Set_HW_Prof_Flags(jitter):
    """"
...
def cfgmgr32_CM_Set_HW_Prof_Flags_Ex(jitter):
    """"
...
def cfgmgr32_CM_Unregister_Device_Interface(jitter):
    """"
...
def cfgmgr32_CM_Unregister_Device_Interface_Ex(jitter):
    """"
...
def cfgmgr32_CM_Delete_Device_Interface_Key_Ex(jitter):
    """"
...
def cfgmgr32_CM_Open_Device_Interface_Key_Ex(jitter):
    """"
